...
/*
    ...
    Date : 17/01/2022
	Description : 
		Add an option to clamp a wheel of a vehicle.
	Installation :
		Replace your files with this
*/
#define Btn1 37450
#define Btn2 37451
#define Btn3 37452
...
#define Btn5 37454
#define Btn6 37455
#define Btn7 37456 // Ajout
#define Title 37401
private ["_display","_curTarget","_Btn1","_Btn2","_Btn3","_Btn4","_Btn5","_Btn6","_id","_Btn7"];
if (!dialog) then {
...
if (playerSide isEqualTo west) then {
    ...
    // Nov Wheel Clamp - Cops
    _Btn7 ctrlSetText localize "STR_NOV_WClamp_PlaceRemoved";
    _Btn7 buttonSetAction "[] spawn nov_fnc_NovSetWheelClamp; closeDialog 0;";
